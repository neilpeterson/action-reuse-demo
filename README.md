...
Where applicable, each resource is configured to send diagnostics and metrics to an Azure Log Analytics workspace. This data can be used for creating alerts and other cool things.
